...
public class SuffixArray{
     ...
     */
    public void makeLCPArray( int [ ] s, int [ ] sa, int [ ] LCP ){
        int N = sa.length;
        int [ ] rank = new int[ N ];
    ...
    public void makeSuffixArray( int [ ] s, int [ ] SA, int n, int K ){
        int n0 = ( n + 2 ) / 3;
        int n1 = ( n + 1 ) / 3;
        int n2 = n / 3;
    ...
    private int assignNames( int [ ] s, int [ ] s12, int [ ] SA12,
    ...
    private void radixPass( int [ ] in, int [ ] out, int [ ] s, int offset,
                                  int n, int K ){ 
    ...
    private void merge( int [ ] s, int [ ] s12,
    ...
    private boolean suffix12IsSmaller( int [ ] s, int [ ] s12, int [ ] SA12,
    ...
    public void run( String file ){
        ...
        LongestRepeatedSubString lrs = new LongestRepeatedSubString(10);
        String str = lrs.readFile(file);
        ...
        lrs.init_lcpOccurrences(LCP);
        
        // The value of k is actually 2 but we start it at 0
        // actual       k = {2, 3, 4, 5, 6, 7, 8, 9, 10}
        // this moment  k = {0, 1, 2, 3, 4, 5, 6, 7, 8}
        for( int k = 0; k < 9; k++ ){
            lrs.lrsKthOccurence(sufarr, k);
        }
    }
    

//    public void printV( int [ ]  a, String comment ){
...
//    public boolean isPermutation( int [ ] SA, int n ){
...
//    public boolean sleq( int  [ ] s1, int start1, int [ ] s2, int start2 ){
...
//    public boolean isSorted( int [ ] SA, int [ ] s, int n ){
//        for( int i = 0; i < n-1; i++ )
...
//    public void assert0( boolean cond ){
//        if( !cond )
...
//    }
     ...
     */
//    public int computeLCP( String s1, String s2 ){
//        int i = 0;
//        
...
//    }
     ...
     */
//    public void createSuffixArraySlow( String str, int [ ] SA, int [ ] LCP ){
